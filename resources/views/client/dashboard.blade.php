        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg font-medium mb-4">Selamat Datang,
                        {{ Illuminate\Support\Facades\Auth::user()->entity->name ?? Illuminate\Support\Facades\Auth::user()->name }}!
                    </h3>
                    ...
                    <div class="overflow-x-auto mt-6">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-700">
                                ...
                                $hasSubmitted = $request->documents->contains('uploaded_by',
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="text-center py-3 px-4">
                                        <a href="{{ route('client.requests.documents.create', $request->id) }}"
