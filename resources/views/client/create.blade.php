        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('client.requests.documents.store', $documentRequest->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            @if ($errors->any())
                        ...
                        <div class="mb-4">
                            <label for="title" class="block text-sm font-medium text-gray-700">Judul/Perihal Dokumen</label>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="document_date" id="document_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="file" class="block text-sm font-medium text-gray-700">Pilih File (PDF, Word, Excel, maks: 10MB)</label>
                            <input type="file" name="file" id="file" class="mt-1 block w-full" required>
                        </div>

                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('client.dashboard') }}" class="text-gray-600 hover:text-gray-800 mr-4">Kembali</a>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="text-center py-4 text-gray-500">Belum ada dokumen yang diunggah untuk permintaan ini.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
