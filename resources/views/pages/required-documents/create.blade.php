                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('required-documents.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="name" name="name" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" value="{{ old('name') }}" required>
                        </div>

                        <div class="mb-4">
                            <label for="service_type" class="block font-medium text-sm text-gray-700">Jenis Layanan</label>
                            <input type="text" id="service_type" name="service_type" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" value="bebas_temuan" required>
