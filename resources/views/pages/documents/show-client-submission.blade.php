            ...
            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex flex-wrap justify-between items-start gap-4">
                    ...
                    <div class="flex items-center flex-wrap gap-2">
                        <a href="{{ route('documents.download', $document->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-500">Unduh File</a>
                    ...
                    @can('can-disposition')
                        <div x-data="{ open: false }">
                            <button @click="open = true" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-500">Disposisi</button>
                            ...
                            <tbody class="text-gray-700">
                                @forelse ($activities as $activity)
                                    <tr class="border-b">
                                        ...
                                        <td class="py-3 px-4">{{ $activity->created_at->translatedFormat('d M Y, H:i') }}</td>
                                    </tr>
                                @empty
                                    <tr>
