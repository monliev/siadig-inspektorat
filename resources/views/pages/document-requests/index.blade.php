<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('document-requests.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500">
                                ...
                                @forelse ($requests as $request)
                                    <tr class="border-b hover:bg-gray-50">
                                        ...
                                        <td class="text-center py-3 px-4">
                                            <a href="{{ route('document-requests.show', $request->id) }}" class="text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded">Lihat Progres</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
