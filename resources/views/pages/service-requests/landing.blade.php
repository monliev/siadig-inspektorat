            ...
            <div class="max-w-4xl mx-auto py-12 sm:py-16">
                ...
                <div class="text-center">
                    ...
                    <p class="mt-4 text-lg text-slate-600">
                        Informasi dan alur pengajuan surat keterangan bebas temuan bagi Aparatur Sipil Negara (ASN) di lingkungan Pemerintah Kabupaten Trenggalek.
                    </p>
                </div>
                ...
                <div class="mt-12 bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl p-6 sm:p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-slate-600">Surat Keterangan Bebas Temuan didasarkan kepada ASN atau Rekanan yang tidak memiliki temuan terkait Pemeriksaan Inspektorat, Pemeriksaan BPK RI, dan Pemeriksaan Inspektorat Jenderal Kementerian Dalam Negeri.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-slate-600">Untuk informasi lebih lanjut atau pengaduan layanan, silakan hubungi kami melalui email: <a href="mailto:inspektorat@trenggalekkab.go.id" class="text-indigo-600 hover:underline">inspektorat@trenggalekkab.go.id</a></p>
                        </div>
                    </div>
                </div>

                <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <a href="{{ route('login.skbt') }}" class="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-indigo-600 bg-indigo-100 hover:bg-indigo-200">
                        Login (Jika Sudah Punya Akun)
                    </a>
                    <a href="{{ route('register') }}" class="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
