            ...
            <div class="md:col-span-2 space-y-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <p><strong>Tanggal Pengajuan:</strong> {{ $serviceRequest->created_at->format('d F Y, H:i') }}
                        </p>
                        ...
                        <ul class="list-disc list-inside space-y-2">
                            ...
                            <li>
                                ...
                                <a href="{{ Storage::url($document->file_path) }}" target="_blank"
                                    class="text-indigo-600 hover:underline ml-2">Lihat/Unduh Dokumen</a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <textarea id="notes" name="notes" rows="4"
                                        class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                        placeholder="Tuliskan dokumen apa yang kurang atau perlu diperbaiki..."
                        ...
                        <form action="{{ route('service-requests.approve', $serviceRequest->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label for="final_document" class="block font-medium text-sm text-gray-700">Unggah Surat
                                    Bebas Temuan Final (PDF)</label>
                                <input type="file" name="final_document" id="final_document"
