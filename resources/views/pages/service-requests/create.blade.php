        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <p class="mb-4 text-gray-600">Silakan unggah semua dokumen persyaratan yang tercantum di bawah ini.</p>
                    ...
                    <form action="{{ route('service-requests.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="border-t border-gray-200 pt-6">
                                ...
                                @endif
                                <input type="file" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none mt-2" id="doc_{{ $doc->id }}" name="doc_{{ $doc->id }}" required>
                            </div>
                            @empty
