                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('entities.index') }}" method="GET" class="mb-4">
                        <div class="flex space-x-2">
                            <input type="text" name="search" placeholder="Cari nama entitas atau induknya..."
                                value="{{ $search ?? '' }}"
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-200">
                                <tr>
                                    <th class="text-left py-3 px-4 uppercase font-semibold text-sm">Nama OPD (Entitas)
                                    </th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr class="border-b hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('entities.edit', $entity->id) }}"
                                ...
                                <tr>
                                    <td colspan="4" class="text-center py-10 text-gray-500">
                                        @if ($search)
                                        Tidak ada entitas yang cocok dengan kata kunci <span
