                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('document-categories.update', $documentCategory->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $documentCategory->name) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                        </div>
                        <div class="mb-4">
                            <label for="description" class="block text-sm font-medium text-gray-700">Deskripsi</label>
                            <textarea name="description" id="description" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('description', $documentCategory->description) }}</textarea>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center">
                                    ...
                                    <label for="scope_internal"
                                        class="ms-3 block text-sm font-medium text-gray-700">Internal (Hanya untuk
                                        Inspektorat)</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="scope_external" name="scope" type="radio" value="external"
                                        ...
                                        class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
                                    <label for="scope_external"
                                        class="ms-3 block text-sm font-medium text-gray-700">Eksternal (Untuk OPD &
                                        Desa)</label>
                                </div>
                            </div>
                        </div>
