                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2 space-y-2">
                                <div class="flex items-center">
                                    <input id="scope_internal" name="scope" type="radio" value="internal" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" checked>
                                    <label for="scope_internal" class="ms-3 block text-sm font-medium text-gray-700">Internal (Hanya untuk Inspektorat)</label>
                                </div>
                                <div class="flex items-center">
                                    <input id="scope_external" name="scope" type="radio" value="external" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300">
