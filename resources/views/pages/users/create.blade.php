            ...
            <div class="bg-white overflow-visible shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="phone_number" class="block text-sm font-medium text-gray-700">Nomor WhatsApp
                                (Opsional)</label>
                            <input type="text" name="phone_number" id="phone_number"
                                value="{{ old('phone_number', $user->phone_number ?? '') }}"
                                class="mt-1 block w-full ..." placeholder="Contoh: 6281234567890">
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="entity_id" class="block text-sm font-medium text-gray-700">Entitas Terkait
                                (untuk Klien Eksternal)</label>
                        ...
                        <p class="text-sm text-gray-600 mb-4">Password akan otomatis dibuat: 'TrenggalekMeroket#!'.
                            Pengguna disarankan untuk mengubahnya setelah login pertama kali.</p>
